...
const CreateType = ({ createTypeModalVisible, setCreateTypeModalVisible }) => {
    ...
    const createActivityType = (event) => {
        ...
        post(route("activities-types.store"), {
            onSuccess: () => {
                reset();
    ...
    return (
        ...
        >
            ...
            <CModalFooter>
                <CButton color="secondary" onClick={() => setCreateTypeModalVisible(false)}>
                    Fechar
                </CButton>
                <CButton
                    color="primary"
